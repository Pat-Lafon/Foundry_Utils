...
/**
 * Recovery periods that reset on a long rest.
 * "lr" = long rest, "day" = daily (also resets on long rest).
 *
 * "day" was important because Channel Divinity: Harness Divine Power should be
 * long rest but is internally recorded as "day"
 */
const LONG_REST_PERIODS = new Set(["lr", "day"]);
