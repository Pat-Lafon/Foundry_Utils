 ...
 *
 * TODO: This operates per-class, but 5e recovery budget is based on total HD
 * across all classes. Multi-class characters will over-recover. Needs a
 * budget-based picker (like arcane recovery) with auto-allocate option.
 *
